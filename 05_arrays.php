...
// $fruits = array("Banana", "Apple", "Orange");   //Older syntax
...
$fruits[0] = 'Peach'; //will change Banana to Peach

// Check if array has element at index 2 and 3
isset($fruits[2]);//true
...
$todos = [
  ['title' => 'Todo title 1', 'comleted' => true],
  ['title' => 'Todo title 2', 'comleted' => false]
];